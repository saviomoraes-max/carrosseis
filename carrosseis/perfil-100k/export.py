...
async def export_slides():
    async with async_playwright() as p:
        ...
        await page.wait_for_timeout(3000)  # aguarda Google Fonts

        # Esconde o chrome do IG frame, mostra só o viewport do slide
        # (body bg matching slide bg evita vazamento de creme nas bordas)
        await page.evaluate(
            """() => {
