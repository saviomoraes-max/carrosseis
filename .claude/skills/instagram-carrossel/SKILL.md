...
## Auto-load — read before any other step

Before doing anything else in this skill (including Step 1), read these two
files in full and treat their content as binding context for the rest of the
session:

1. `~/.agents/skills/brand-guidelines/SKILL.md` — official brand colors and
   typography. Pull palette and fonts from here. Never invent.
2. `~/.agents/skills/instagram-design/SKILL.md` — layout grid, typography
   scale, whitespace rules, narrative arc, and the "Don'ts" list. Validate
   every slide against section 10 before exporting.

If either file is missing or unreadable, stop and tell the user before
proceeding.
...
| Ultra-bold / viral | Thunder | Brunson Rough |
| Elegant bold | Creato Display | Plus Jakarta Sans |
| Serif editorial bold | Bethany Elingston | Neulis Neue |

> **Nota — fontes viral:** Thunder, Brunson Rough, Creato Display, Bethany Elingston e Neulis Neue não estão no Google Fonts. Baixar em fontes como DaFont, Befonts ou FontShare e servir via `@font-face` local na geração do HTML.
...
| Autoridade + loop aberto | "Fiz 2.500 carrosséis. Aqui está o que eu queria ter sabido antes." |
...
### 30 Hook Templates (parametrizados)

Use `[colchetes]` como variáveis — substitua pelo contexto do post antes de gerar.

| # | Template |
|---|---|
| 1 | Stop doing [forma antiga] if you want [resultado melhor] |
| 2 | [X] mistakes keeping you stuck at [nível atual] |
| 3 | What nobody tells you about [tópico] |
| 4 | The [verdade difícil] about getting [resultado desejado] |
| 5 | If I had to start [objetivo/tópico] from scratch, I'd do this |
| 6 | [Número] signs you're doing [atividade] wrong |
| 7 | The fastest way to go from [problema] to [resultado] |
| 8 | Why [crença comum] is ruining your [resultado] |
| 9 | [Número] things I wish I knew before [ponto de partida] |
| 10 | What smart [público-alvo] do differently about [tópico] |
| 11 | The old way vs. the new way of [obter resultado] |
| 12 | [Número] red flags to watch for in [setor/tópico] |
| 13 | How to get [resultado] without [coisa dolorosa] |
| 14 | The biggest lie you've been told about [tópico] |
| 15 | If you're struggling with [problema], read this |
| 16 | [Número] overlooked reasons you're not seeing [resultado] |
| 17 | What I'd do today if I wanted [resultado] fast |
| 18 | [Tópico] is not your problem — [problema real] is |
| 19 | The exact framework I use for [processo/resultado] |
| 20 | [Número] habits of people who are great at [skill/tópico] |
| 21 | What to do when [situação frustrante comum] happens |
| 22 | The most underrated way to improve [resultado] |
| 23 | [Número] things that changed everything for me in [tópico] |
| 24 | You don't need [coisa popular] to get [resultado] |
| 25 | [Número] myths about [tópico] that need to die |
| 26 | Here's why your [estratégia/sistema] isn't working |
| 27 | A simpler way to [alcançar resultado] |
| 28 | What people think about [tópico] vs. reality |
| 29 | Before you [tomar ação], make sure you know this |
| 30 | The [iniciante/avançado] guide to [resultado específico] |
...
### Narrative Arc (10 slides) ⭐ formato viral

Estrutura de 5 zonas funcionais para posts de alto engajamento e salvamento.

| Zona | Slides | Tipo | Papel narrativo |
|------|--------|------|-----------------|
| **1. THE HOOK** | 1 | Hero | Parar o scroll — afirmação ousada, número, inversão |
| **2. THE TRANSITION** | 2 | Bridge | O que o leitor ganha / evita / por que você é qualificado |
| **3. THE TEASE** | 3–7 | Content | Revelar aos poucos — exemplos, dados, visuais. Cada slide precisa de um motivo para o próximo. |
| **4. THE CLIMAX** | 8–9 | Insight | O "Aha moment" — grande revelação, lição, insight prático |
| **5. THE ACTION** | 10 | CTA | Próximo passo óbvio |

**Regras específicas deste formato:**
- Slide 2 deve responder: *"O que EU ganho se continuar lendo?"*
- Slides 3–7: cada um entrega uma micro-recompensa que justifica o próximo swipe (estatística, exemplo real, visual impactante)
- Em carrosseis 8+ slides, inserir um **mid-carousel Save CTA** entre a zona Tease e o Climax (ver componente abaixo)
- Slide 10 CTA: ação simples + benefício concreto ("Salve este post e use no próximo carrossel")
...
| Aspect ratio | Pixels | Quando usar |
|---|---|---|
| **3:4** | 1080×1440 | **Padrão para feed orgânico** — mais área de tela no mobile |
| 4:5 | 1080×1350 | Posts que serão impulsionados (ads) |
| 1:1 | 1080×1080 | Evitar — muito espaço desperdiçado no feed |

**Default:** 3:4 (1080×1440) para feed orgânico, salvo instrução contrária.

> **Atenção:** carrosseis com música adicionada aparecem automaticamente na aba Reels.
...
### Mid-carousel Save CTA (slides 5–7 em carrosseis longos)

Inserir entre a zona Tease e o Climax para maximizar o save rate. Usar foto do criador/brand + ícone de bookmark.

```html
<!-- Mid-carousel Save CTA — fundo LIGHT_BG ou DARK_BG -->
<div style="display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;padding:40px 36px;text-align:center;gap:24px;">
  <!-- Pergunta de engajamento -->
  <p class="sans" style="font-size:13px;color:{muted};letter-spacing:0.5px;">Achando útil até aqui?</p>

  <!-- CTA principal bold -->
  <h2 class="serif" style="font-size:32px;font-weight:700;line-height:1.1;color:{heading};">
    Salve este post<br>& use no seu<br>próximo carrossel
  </h2>

  <!-- Ícones de bookmark (SVG inline) -->
  <div style="display:flex;gap:16px;margin-top:8px;">
    <svg width="48" height="48" viewBox="0 0 24 24" fill="{BRAND_PRIMARY}">
      <path d="M5 3h14a2 2 0 0 1 2 2v16l-7-3-7 3V5a2 2 0 0 1 2-2z"/>
    </svg>
    <svg width="48" height="48" viewBox="0 0 24 24" fill="{BRAND_LIGHT}">
      <path d="M5 3h14a2 2 0 0 1 2 2v16l-7-3-7 3V5a2 2 0 0 1 2-2z"/>
    </svg>
  </div>
</div>
...
> **Quando usar:** somente em carrosseis com 8+ slides (Narrative Arc). Não inserir em carrosseis padrão de 7 slides.
...
### Safe Zone (capa / Slide 1)

A capa tem elementos de UI do Instagram sobrepostos nas bordas. Manter conteúdo fora dessas margens:

```
┌─────────────────────────────┐
│         180px top           │  ← handle, stories ring
│  50px ◄──────────► 120px   │  ← esquerda limpa / direita: ícone de múltiplas imagens
│                             │
│   ✅ SAFE ZONE              │
│                             │
│         180px bottom        │  ← likes, comentários, salvamento
└─────────────────────────────┘
```
...
> Estes valores são para a **capa (Slide 1)**. Nos slides internos, as margens padrão de `36px` são suficientes — o header do Instagram não aparece em slides não-capa.
...
### Quality Checklist — rodar antes de mostrar o preview

Antes de apresentar o HTML ao usuário, verificar mentalmente cada item:

**Squint Test** — entorne os olhos e veja o slide a 50% de zoom:
- [ ] A hierarquia tipográfica ainda é legível? (título domina, corpo recua)
- [ ] O elemento mais importante do slide é o primeiro que os olhos encontram?

**Design — sinais de carrossel fraco (evitar):**
- [ ] ❌ Imagens com recorte ruim ou bordas serrilhadas
- [ ] ❌ Elementos desalinhados (texto, ícones, divisores)
- [ ] ❌ Hierarquia de texto plana — tudo no mesmo tamanho/peso
- [ ] ❌ Cores inconsistentes entre slides
- [ ] ❌ Texto ilegível em tamanho reduzido (testar a 200px de largura)

**Design — sinais de carrossel viral (garantir):**
- [ ] ✅ Hierarquia clara: título > subtítulo > corpo
- [ ] ✅ Imagens profissionais e com cutout limpo quando aplicável
- [ ] ✅ Elementos alinhados a grid consistente
- [ ] ✅ Cores consistentes conforme o sistema definido
- [ ] ✅ Legível em tamanho de thumbnail
- [ ] ✅ Imagens grandes e com impacto visual
- [ ] ✅ Progress bar presente em todos os slides

**Copy:**
- [ ] Slide 1 tem hook que cria loop aberto (promete algo que os próximos slides entregam)?
- [ ] Cada slide tem um motivo para o usuário ir ao próximo?
- [ ] CTA do último slide tem ação simples + benefício concreto?
...
#   3:4 (1080×1440) → feed orgânico — padrão recomendado
#   4:5 (1080×1350) → posts impulsionados / ads
#   1:1 (1080×1080) → evitar
VIEW_W = 420
VIEW_H = 560   # 3:4 orgânico → 420×560 | 4:5 ads → 420×525
SCALE = 1080 / 420  # = 2.5714... (mesmo para ambos os formatos)

async def export_slides():
    async with async_playwright() as p:
        browser = await p.chromium.launch()
        page = await browser.new_page(
            viewport={"width": VIEW_W, "height": VIEW_H},  # 420×560 (3:4) ou 420×525 (4:5)
